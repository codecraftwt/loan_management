...
export function Revenue() {
  ...
  <div className="p-4 md:p-6 lg:p-8 bg-gray-50 min-h-screen">
    ...
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
      <h2 className="text-xl md:text-2xl font-bold text-gray-900">Revenue Report</h2>
    ...
    <div className="mb-6 md:mb-8 ">
      ...
      >
        <h2 className="text-base md:text-lg font-bold text-gray-900 flex items-center gap-3">
          <CiFilter className="w-5 h-5 md:w-6 md:h-6 text-orange-600" />
          All Data
        </h2>
      </div>
    </div>
      ...
      <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-sm font-semibold text-gray-400 leading-relaxed">{selectedCard.description}</p>
          </div>
        </div>
      </div>
    )}
      ...
      <>
        ...
        {showByMonth && (
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 gap-4 md:gap-6">
              {monthly.length > 0 ? monthly.map((month, index) => (
        ...
        {showByYear && (
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 gap-4 md:gap-6">
              {yearly.length > 0 ? yearly.map((year, index) => (
                <div key={index} className="bg-white rounded-xl shadow-sm p-5 md:p-6 border border-gray-200 hover:shadow-md hover:border-orange-300 transition-all">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        <div className={`p-3 rounded-lg flex items-center gap-3 ${
                          purchase.remainingDays > 30 ? "bg-green-50" :
                          ...
                          <div>
                            ...
                            <p className={`text-xs font-bold ${
                              purchase.remainingDays > 30 ? "text-green-700" :
      ...
      <div className="mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Pie 1 — Revenue share */}
            <div>
              <p className="text-xs text-gray-400 font-bold uppercase tracking-widest mb-4 text-center">Revenue Share by Plan</p>
            ...
            <div>
              <p className="text-xs text-gray-400 font-bold uppercase tracking-widest mb-4 text-center">Active vs Expired Purchases</p>
              <ResponsiveContainer width="100%" height={280}>
                <PieChart>
                  <Pie
                    data={[
    ...
    {showByMonth && monthly.length > 0 && (
      <div className="mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8">
          ...
          <p className="text-xs text-gray-400 font-bold uppercase tracking-widest mb-4 text-center">Revenue Share by Month</p>
          <ResponsiveContainer width="100%" height={320}>
            <PieChart>
              <Pie
    ...
    {showByYear && yearly.length > 0 && (
      <div className="mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8">
          ...
          <p className="text-xs text-gray-400 font-bold uppercase tracking-widest mb-4 text-center">Revenue Share by Year</p>
